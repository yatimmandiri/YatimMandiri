...
<div class="content-header">
    <div class="container-fluid">
        <div class="card card-outline card-primary">
            <form method="POST" id="formCampaignCreate" enctype="multipart/form-data">
                @method('POST')
                @csrf
                ...
                <div class="card-body row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="campaign_nominal_min" placeholder="Nominal Minimum" class="form-control" id="campaign_nominal_min">
                    </div>
                    <div class="form-group col-md-6">
